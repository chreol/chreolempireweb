...
const SEARCH_INDEX: SearchItem[] = [
  ...
  { type: "service", emoji: "🎫", label: "Coupons Transcash / PCS",       sub: "450 FCFA/€ — échange immédiat",                    href: "/services/coupons",         tags: ["transcash","pcs","coupon","voucher","mastercard","coupons","code"] },
  ...
  { type: "product", emoji: "🎮", label: "PSN 20€",       sub: "15 800 FCFA", href: "/services/cartes-cadeaux?tab=standard&card=psn&amount=20%E2%82%AC&region=EU", tags: ["psn","20","playstation"] },
  { type: "product", emoji: "🎮", label: "Steam 20€",     sub: "15 800 FCFA", href: "/services/cartes-cadeaux?tab=standard&card=steam&amount=20%E2%82%AC&region=EU", tags: ["steam","20","pc","jeux"] },
  { type: "product", emoji: "👾", label: "Robux 800R",    sub: "10 500 FCFA", href: "/services/cartes-cadeaux?tab=robux&card=robux&amount=800%20Robux&region=EU", tags: ["robux","roblox","800","enfants"] },
  { type: "product", emoji: "₿",  label: "USDT 10$",      sub: "5 800 FCFA",  href: "/services/crypto",          tags: ["usdt","10","trc20","crypto"] },
  { type: "product", emoji: "🎵", label: "iTunes 25€",    sub: "18 500 FCFA", href: "/services/cartes-cadeaux?tab=itunes&card=itunes&amount=25%E2%82%AC&region=EU", tags: ["itunes","25","apple","musique","ios"] },
  { type: "product", emoji: "💸", label: "PayPal 20€",    sub: "11 600 FCFA", href: "/services/paypal",          tags: ["paypal","20","euro"] },
  { type: "product", emoji: "🎮", label: "Nintendo 50€",  sub: "35 800 FCFA", href: "/services/cartes-cadeaux?tab=standard&card=nintendo&amount=50%E2%82%AC&region=EU", tags: ["nintendo","50","switch","eshop"] },
