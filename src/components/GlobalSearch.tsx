...
const SEARCH_INDEX: SearchItem[] = [
  ...
  { type: "service", emoji: "₿",  label: "Crypto & Échange MoMo",        sub: "USDT, BTC, TRX, ETH — 0% commission",              href: "/services/crypto",          tags: ["usdt","btc","trx","eth","sol","ltc","ada","bnb","crypto","bitcoin","momo","fcfa","blockchain","hash","txid"] },
  { type: "service", emoji: "🎫", label: "Coupons Transcash / PCS",       sub: "440 FCFA/€ — échange immédiat",                    href: "/services/coupons",         tags: ["transcash","pcs","coupon","voucher","mastercard","coupons","code"] },
