...
export const POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    description: "Comment échanger un coupon Transcash ou PCS Mastercard en FCFA au Cameroun ? Taux : 440 FCFA/€. Paiement MTN MoMo ou Orange Money. Guide 2026 par Chreol Empire.",
    date: "10 mai 2026",
    dateISO: "2026-05-10",
    readTime: 6,
    ...
    sections: [
      ...
      { type: "ul", items: [
        "Transcash : 440 FCFA par euro — 0% de commission.",
        "PCS Mastercard : 440 FCFA par euro après déduction de 7% de commission.",
