...
export const metadata: Metadata = {
  ...
  description: "Échangez vos coupons Transcash ou PCS Mastercard contre du FCFA à Douala. Taux garanti 450 FCFA/€. Paiement instantané MTN MoMo ou Orange Money. Cameroun.",
  ...
  openGraph: {
    ...
    description: "450 FCFA/€ garanti. Échangez vos coupons en moins de 30 min. MTN MoMo / Orange Money.",
...
const SERVICE_SCHEMA = {
  ...
  "description": "Échangez vos coupons Transcash ou PCS Mastercard contre du FCFA au taux de 450 FCFA/€ à Douala. Paiement MTN MoMo ou Orange Money en 15-30 min.",
